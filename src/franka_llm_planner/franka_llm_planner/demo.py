...
from franka_llm_planner import FrankaHelperReal, FrankaManipulation
...
manip.move_to_joints(destination_point, velocity_scaling=0.5)
time.sleep(2)
manip.open_gripper(width=0.03)
time.sleep(2)

manip.move_to_joints(start_point, velocity_scaling=0.5)
time.sleep(2)
